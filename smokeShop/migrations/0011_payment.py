# Generated by Django 4.1.4 on 2023-02-14 18:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('smokeShop', '0010_remove_orderitem_price_total'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smokeShop.order')),
            ],
            options={
                'abstract': False,
            },
